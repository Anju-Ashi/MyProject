...
public class Assertion {
    ...
    public void assertEquals(){
        ...
        Assert.assertEquals("assertion","assertion1");
	 ...
	 @Test
	    public void assertNotEquals(){
	        ...
	        Assert.assertNotEquals("This assertion will pass", "This assertion will pass");
	        System.out.println("This line will not be executed because "
	                + "assertNotEquals fails both the strings are different."
	                + "Also the test/method will be declared failed");
}
	 @Test
